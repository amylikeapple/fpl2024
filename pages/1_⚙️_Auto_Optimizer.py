...
if len(weekly_table_file) > 0  and len(new_data_file) >0:
    ...
    st.write(players_to_remove[['Name', 'Position', 'Team_x','Current Price','EventPoints','Form', 'Form_%_15','Threat_%_15','Crtvty_%_15','PP_GW','Next_GW_%_15','PPNext3','PP3_%_15','Prob. of Appearring','Adjusted Metric','Removal Metric']])
    ...
    updated_weekly_table_style = updated_weekly_table[['Name', 'Position', 'Team_x','Current Price','EventPoints','Form', 'Form_%_15','Threat_%_15','Crtvty_%_15','PP_GW','Next_GW_%_15','PPNext3','PP3_%_15','Prob. of Appearring']].style\
                       .format(precision=2)\
